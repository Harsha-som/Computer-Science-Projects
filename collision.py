...
CS152
project9
mimic collision of objects
change directory to project 9 and run py.collsion.py to call
'''
# Bruce A. Maxwell
# CS 151S
# Fall 2015
...
def collision(ball, thing, timestep):
    '''refers to approprate router deping on thing type'''
