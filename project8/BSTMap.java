...
public class BSTMap<K, V> implements MapSet<K, V> {
        ...
        public void calcuateDepth(TNode root, int depth) {
                /**
                 * recursive for depth  runner
                 */
                if (root == null) {// empty
                        return;
                }
                calcuateDepth(root.left, depth + 1);
                calcuateDepth(root.right, depth + 1);
        ...
        public static void main(String[] argv) {
                ...
                System.out.println(bst.mostCommon(2));
                bst.clear();
